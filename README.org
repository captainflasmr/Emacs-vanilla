...
- Bound =Z= in dired to =my/dired-do-compress= via =[remap dired-do-compress]=; if any marked file is already compressed, decompresses directly via =dired-do-compress= instead of showing the transient
